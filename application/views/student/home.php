...
<body>
	<div class="d-flex justify-content-start align-items-center align-self-center header student">
        <div class="container">
	...
	<div class="container">
        <div class="row">
            ...
            <div class="col home-schedule-box">
                <h3 class="d-inline p-2">Next Exam</h3>
                <div class="table-responsive mt-3">
                    <table class="table table-hover table-light">
                        <thead class="thead-light">
                            <tr>
                        ...
                        <tbody>
							<?php foreach ($exam as $data): ?>
								<tr>
								<th scope="row"><?php echo $data['ExamSchedule']; ?></th>
								<td><?php echo $data['SubjectID'] ;?></td>
								<td><?php echo $data['ChapterName'] ;?></td>
								</tr>
							<?php endforeach;?>
                        </tbody>
                    </table>
