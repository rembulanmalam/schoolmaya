...
<body>
	...
	<div class="d-flex justify-content-start align-items-center align-self-center header-small student">
        <div class="container">
            <h1 class="display-3">Your Score</h1>
        </div>
	</div>
		...
		<table class="table table-hover table-light">
			...
			<tbody>
				<?php foreach ($scores as $score): ?>
						<tr>
							<td scope="row"><?php echo $score['SubjectID']; ?></td>
							<td scope="row"><?php echo $score['ChapterID']; ?></td>
							<td scope="row"><?php echo $score['ChapterName'] ;?></td>
							<td scope="row"><?php echo $score['Score'] ;?></td>
						</tr>
				<?php endforeach;?>
			</tbody>
		</table>
