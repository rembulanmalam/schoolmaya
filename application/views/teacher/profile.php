...
<body>
    <!-- Header -->
	<div class="d-flex justify-content-start align-items-center align-self-center header-small teacher">
        <div class="container">
		...
		<div class="row">
			<div class="col-5">
				...
				<form action="update/" method = "POST">
					...
					<button id="confirm" type="submit" class="btn btn-primary teacher-btn" style="font-size:14px" data-toggle="modal" data-target="#myModal">Submit</button>
				</form>
			</div>
		</div>
    </div>
