...
<head>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				...
				<li class="nav-item active">
					<a class="nav-link" href="<?php echo (base_url('index.php/classes/')) ?>">Class <span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
    ...
    <title>Schoolmaya | Your Class</title>
</head>
<body>
	...
	<div class="container mt-5">
		<h1><?php echo $subject[1]['ClassName']?></h1>
	</div>
