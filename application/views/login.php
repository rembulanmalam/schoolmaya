			...
			<div class="col">
				...
				<form action = "index.php/login/process/" method = "POST" >
					<div class="form-group">
						...
						<input type="text" class="form-control w-25" placeholder="Enter username" name = "username">
					</div>
					<div class="form-group">
						<label for="username">Password</label>
						<input type="password" class="form-control w-25" placeholder="Password" name = "password">
					</div>
